<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddProduct.aspx.cs" Inherits="Project_3.AddProduct" %>
...
<head runat="server">
    ...
    <style>
        ...
        .btnAdd { background: #0056ff; color: white; border: none; width: 100%; height: 45px; font-size: 18px; font-weight: bold; border-radius: 5px; margin-top: 20px; cursor: pointer; }
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="formContainer">
            <div class="formTitle">Add New Product</div>
            <span class="formLabel">Product Name</span>
            <asp:TextBox ID="txtProductName" runat="server" CssClass="formInput" placeholder="Enter product name"></asp:TextBox>
            <span class="formLabel">Category</span>
            <asp:TextBox ID="txtCategory" runat="server" CssClass="formInput" placeholder="Enter category"></asp:TextBox>
            <span class="formLabel">Description</span>
            <asp:TextBox ID="txtDescription" runat="server" CssClass="formTextArea" TextMode="MultiLine" Rows="3" placeholder="Enter description"></asp:TextBox>
            <span class="formLabel">Price (R)</span>
            <asp:TextBox ID="txtPrice" runat="server" CssClass="formInput" placeholder="Enter price"></asp:TextBox>
            <span class="formLabel">Image Path</span>
            <asp:TextBox ID="txtImagePath" runat="server" CssClass="formInput" placeholder="e.g. ~/Images/product.jpeg"></asp:TextBox>
            <asp:Button ID="btnAddProduct" runat="server" Text="Add Product" CssClass="btnAdd" OnClick="btnAddProduct_Click" />
